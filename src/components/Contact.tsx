    ...
    <section id="kontakt" className="py-24 bg-neutral-100">
      <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-start">
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Kontaktujte mě</h2>
          {submitted ? (
          ...
          <div className="flex justify-center">
            <div className="bg-white p-8 rounded-xl shadow-md mt-8 space-y-2 text-base w-full max-w-md">
